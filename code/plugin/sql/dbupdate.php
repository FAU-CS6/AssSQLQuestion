...
if(!$ilDB->tableExists('il_qpl_qst_qpisql_qsm'))
{
  $fields = array(
    ...
    // The id of the scoring metric (second part of the primary key - has to be unique for a single question)
    'id' => array(
      'type' => 'text',
      'length' => 256
    ),
  ...
  $ilDB->addPrimaryKey("il_qpl_qst_qpisql_qsm", array("question_fi","id"));
}
?>

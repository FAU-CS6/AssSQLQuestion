...
\documentclass[a4paper, 12pt, BCOR8.25mm, headsepline, final, bibliography=totoc, listof=totoc, index=totoc, parskip=half*, chapterprefix, appendixprefix, captions=nooneline, origlongtable, oneside]{scrbook}
%
...
%
\input{deckblatt/titleAndContent}
%
%%%%%%%%%%%%%
% Hauptteil %
%%%%%%%%%%%%%
